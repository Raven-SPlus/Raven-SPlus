...
/**
 * @author TIMER_err
 * Smooth visual effect inspired by Jelly.
 */
@Getter
public class GradientBlur {
    ...
    private static final long SAMPLE_INTERVAL_MS = TimeUnit.MILLISECONDS.toMillis(200);
    ...
    public void update(int x, int y, int width, int height) {
        ...
        boolean shouldSample = pixels == null || (now - lastSampleTime) >= SAMPLE_INTERVAL_MS;
        if (shouldSample) {
