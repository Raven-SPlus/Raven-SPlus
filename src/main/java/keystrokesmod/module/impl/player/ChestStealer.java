...
public class ChestStealer extends Module {
    ...
    private final ButtonSetting manageAfterSteal = new ButtonSetting("Auto-manage after steal", true);
    ...
    private void close() {
        ...
        state = State.AFTER;
        // Kick off InvManager immediately after stealing to auto-manage inventory (optional)
        if (manageAfterSteal.isToggled()
                && ModuleManager.invManager != null
                && ModuleManager.invManager.isEnabled()) {
            ModuleManager.invManager.triggerAfterSteal();
        }
    }
