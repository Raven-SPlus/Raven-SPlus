...
public class InvMove extends Module {
    ...
    // Hypixel mode variables
    private int hypixelTicks;
    private boolean hypixelStopMoving;
    ...
    public void onPreUpdate(PreUpdateEvent event) {
        // Handle Hypixel mode tick counter
        ...
        if ((mc.currentScreen instanceof GuiContainer || (clickGui.isToggled() && mc.currentScreen instanceof ClickGui))
            ...
            switch ((int) mode.getInput()) {
                ...
                case 2:
                    ...
                    break;
                case 3: // Hypixel
                    if (hypixelStopMoving) {
                        if (hypixelTicks > 5) {
                            hypixelStopMoving = false;
                        }
                        noInvMove();
                        return;
                    }
    ...
    public void onSendPacket(SendPacketEvent event) {
        ...
        // Hypixel mode: stop movement when clicking in inventory
        if ((int) mode.getInput() == 3 && event.getPacket() instanceof C0EPacketClickWindow) {
            hypixelTicks = 0;
            hypixelStopMoving = true;
        }
