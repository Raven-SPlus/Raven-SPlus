...
public class KillAuraV2 extends Module {
    ...
    public KillAuraV2() {
        ...
        this.registerSetting(mode, switchDelay, minCPS, maxCPS, rotationMode, moveFixMode, rotationSpeed, autoBlock, autoBlockMode, fixNoSlowFlag, preAimRange, attackRange, sortMode, ThroughWalls, RayCast, targetInvisible);
    }
    ...
    public void sortTargets() {
        ...
        for (Entity entity : mc.theWorld.getLoadedEntityList()) {
            if (entity instanceof EntityLivingBase) {
                ...
                if (mc.thePlayer.getDistanceToEntity(entity) <= preAimRange.getInput() && 
                    TargetFilter.isValidTargetWithChecks(entity, false, targetInvisible.isToggled()) && 
