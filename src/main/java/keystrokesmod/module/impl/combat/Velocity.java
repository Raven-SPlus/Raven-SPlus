...
public class Velocity extends Module {
    ...
    public Velocity() {
        ...
        this.registerSetting(mode = new ModeValue("Mode", this)
                ...
                .add(new MatrixReduceVelocity("MatrixReduce", this))
                .add(new MatrixReduce2Velocity("MatrixReduce2", this))
                .add(new MatrixSimpleVelocity("MatrixSimple", this))
                .add(new MatrixReverseVelocity("MatrixReverse", this))
                .add(new MatrixFullVelocity("MatrixFull", this))
