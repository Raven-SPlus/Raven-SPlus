package keystrokesmod.altmanager.auth;
...
import keystrokesmod.altmanager.auth.model.request.MinecraftLoginRequest;
import keystrokesmod.altmanager.auth.model.request.XSTSAuthorizationProperties;
import keystrokesmod.altmanager.auth.model.request.XboxLiveLoginProperties;
import keystrokesmod.altmanager.auth.model.request.XboxLoginRequest;
import keystrokesmod.altmanager.auth.model.response.MicrosoftRefreshResponse;
import keystrokesmod.altmanager.auth.model.response.MinecraftLoginResponse;
