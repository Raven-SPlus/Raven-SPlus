    ...
    public void rf(IFont renderer) {
        ...
        if (ModuleManager.clientTheme.test.isToggled()) {
            ...
            RenderUtils.drawRoundedRectangle(this.x - 2, this.y, this.x + this.width + 2, extra, 5,
                    ClickGUI.translucentBackground.isToggled() ? TRANSLUCENT_NEW_BACKGROUND : NEW_BACKGROUND);
            ...
            RenderUtils.drawRoundedGradientOutlinedRectangle(
                    ...
                    ClickGUI.translucentBackground.isToggled() ? translucentBackground : background,
                    ((categoryOpened || hovering) && ClickGUI.rainBowOutlines.isToggled()) ? RenderUtils.setAlpha(Utils.getChroma(2, 0), 0.5) : regularOutline,
                    ((categoryOpened || hovering) && ClickGUI.rainBowOutlines.isToggled()) ? RenderUtils.setAlpha(Utils.getChroma(2, 700), 0.5) : regularOutline2
            );
